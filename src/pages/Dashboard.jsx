        ...
        if (userData) {
            ...
            const fetchClasses = async () => {
                try {
                    ...
                    const message = err.response?.data?.message || 'Tidak dapat terhubung ke server. Periksa log di konsol backend.';
                    setError(message);
                ...
                <div className="px-4 py-8 sm:px-0">
                    <div className="p-6 bg-white rounded-lg shadow h-96">
                        ...
                        {loading ? (
                            ...
                            <div className="p-4 mt-4 text-red-800 bg-red-100 border border-red-300 rounded-lg">
                    ...
                    <div key={item.id} className="overflow-hidden transition-shadow bg-white rounded-lg shadow hover:shadow-lg ">
                        <div className="p-6">
                            ...
                            <div className="flex mt-4 space-x-2">
                                ...
                                onClick={() => navigate(`/kelas/${item.id}/rekap`)}>
                                    Lihat Rekap
                                </button>
                            </div>
                        </div>
